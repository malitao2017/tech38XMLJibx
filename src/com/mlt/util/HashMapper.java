...
/**
 * <b>function:</b>
 * http://www.java2s.com/Open-Source/Java/XML/JiBX/tutorial/example21/HashMapper
 * .java.htm
 * 
...
public class HashMapper implements IMarshaller, IUnmarshaller, IAliasable {
	...
	public void marshal(Object obj, IMarshallingContext ictx) throws JiBXException {
		...
		if (!(obj instanceof HashMap)) {
			...
			ctx.startTagAttributes(m_index, m_name).attribute(m_index, SIZE_ATTRIBUTE_NAME, map.size())
					.closeStartContent();
			...
			while (iter.hasNext()) {
				...
				if (entry.getKey() != null) {
					ctx.attribute(m_index, KEY_ATTRIBUTE_NAME, entry.getKey().toString());
				}
